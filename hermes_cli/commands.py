...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("insights", "Show usage insights and analytics", "Info",
               args_hint="[days]"),
    CommandDef("cost", "Per-call cost, token, and latency telemetry", "Info",
               cli_only=True, args_hint="<ls|show|export>"),
    CommandDef("cache", "Prompt-cache hit rate and estimated savings", "Info",
               cli_only=True, args_hint="<stats>"),
    CommandDef("whoami", "Show the resolved config stack (defaults/user/repo)",
               "Info", cli_only=True),
    CommandDef("eval", "Run a corpus-driven regression check",
               "Info", cli_only=True, args_hint="<run|list|show|diff>"),
